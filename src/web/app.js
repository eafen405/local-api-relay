...
function usageIntegrityMarkup(integrity) {
  ...
  return `<section class="table-region"><div class="table-heading"><h2>用量完整性</h2><p class="muted">此窗口数据不完整——存在 ${integrity.gaps.length} 个已知缺口；不会估算或回填。</p></div><div class="data-table usage-integrity-table"><div class="table-head"><span>类型</span><span>类别</span><span>开始</span><span>结束</span><span>丢失记录数</span></div>${rows}</div></section>`;
}
